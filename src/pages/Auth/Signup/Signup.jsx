...
const Signup = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    signupUser(userDetails.firstName, userDetails.lastName, userDetails.email, userDetails.password);
  }
  ...
  return (
    <form className='h-full mb-20' onSubmit={submitHandler}>
      ...
      <label className="label">
        <input className='m-auto mt-3 mb-3' type="checkbox" name="label" id="" /> Accept all terms and
        conditions
      </label>
      <button type='submit' className="button-theme bg-slate-900 shadow-md text-slate-200">Create new account</button>
